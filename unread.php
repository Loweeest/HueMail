...
// SQL query to fetch unread emails with pagination and search
$sql = '
...
$total_query = $pdo->prepare("SELECT COUNT(*) FROM emails e WHERE e.user_id = ? AND e.status = 'unread'");
...
<div class="side-panel">
    ...
    <div class="navigation">
        ...
        <a href="unread.php" class="active">
